...
class _SomePageState extends State<SomePage>{
  ...
  // Addresses
  late Address _ip;
  Address _network =   Address("192.168.0.0/24");
  Address _broadcast =   Address("192.168.0.255/24");
  ...
  List<SubNetwork> subNets =   <SubNetwork>[];
  ...
  void updateEven(val) {
    ...
    setState(() {
      ...
      Address helperAddress =   Address(_ip.toString() + "/" + _ip.prefixNum.toString());
      // Resets subNets (so there is no repetition)
      subNets =   <SubNetwork>[];
      subNets.add(  SubNetwork.interface());
  ...
  void updateUnEven(val) {
    ...
    List<int> hostsInSubnetworksNum =  <int>[];
        ...
        body: TabBarView(
          children: <Widget>[
            ListView(
              ...
              children: <Widget>[
                _item.inputItem("192.168.0.10/24", _ipCon, true, _ipWarCol, _ipWar, 18),
